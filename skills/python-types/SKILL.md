---
name: python-types
description: Add and improve Python type hints — annotations on function signatures, generics with TypeVar / PEP 695 syntax, structural typing with Protocol, narrowing via TypeGuard / TypeIs, NewType for domain primitives, Literal, TypedDict, Self, and how to avoid Any. Use when the user asks to "add type hints", "type-annotate this", "fix type errors", "make this typed", "improve typing", or when you see `Any`, `# type: ignore`, or weakly-typed dicts in code under review. Cross-platform.
license: MIT
